        ...
        <div className="grid gap-10 md:grid-cols-5">
          <div className="md:col-span-2">
            ...
            <div className="mt-6 flex items-center gap-3">
              <a
                href="https://www.instagram.com/nextexai"
                target="_blank"
                rel="noopener"
                aria-label="NexTex AI on Instagram"
                className="inline-flex size-10 items-center justify-center rounded-xl text-paper ring-1 ring-inset ring-paper/25 transition-all duration-200 hover:scale-105 hover:bg-paper hover:text-graphite focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-acid"
              >
              ...
              <a
                href="https://de.linkedin.com/company/nextexai"
                target="_blank"
                rel="noopener"
                aria-label="NexTex AI on LinkedIn"
                className="inline-flex size-10 items-center justify-center rounded-xl text-paper ring-1 ring-inset ring-paper/25 transition-all duration-200 hover:scale-105 hover:bg-paper hover:text-graphite focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-acid"
              >
                <svg viewBox="0 0 24 24" width="19" height="19" fill="currentColor" aria-hidden="true" focusable="false">
